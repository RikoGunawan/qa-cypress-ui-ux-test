...
```
cd existing_repo
git remote add origin https://git.neuron.id/ui-testing/qa-training-project.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.neuron.id/ui-testing/qa-training-project/-/settings/integrations)
...
## Contoh File Config untuk Testing
cypress env json
